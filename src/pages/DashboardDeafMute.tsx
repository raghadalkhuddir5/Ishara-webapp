  ...
  const services = [
    {
      ...
      description: t("deaf_dashboard_desc"),
      icon: <EventNoteIcon sx={{ fontSize: { xs: "2.5rem", md: "3rem" }, color: "#008080" }} />,
      link: "/book",
      color: "#008080",
    },
    {
      id: "sessions",
      title: t("my_sessions"),
      description: t("service_scheduled_sessions"),
